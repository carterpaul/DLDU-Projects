# DLDUlib.py                                                  Simmons March 2019
"""
A library collecting common techniques the DL@DU group has implemented.

To use this:
  Put this file -- or a symbolic link to it -- in the directory where your
  program resides. Then, in the file that holds your program, put, for example

  from DLDUlib import train
